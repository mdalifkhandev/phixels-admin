...
export function DropOffsModal({
  ...
  const conversionRate =
    totalLeads > 0 ? ((bookedLeads / totalLeads) * 100).toFixed(1) : "0.0";
  const pendingRate =
    totalLeads > 0 ? ((pendingLeads / totalLeads) * 100).toFixed(1) : "0.0";
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 rounded-xl bg-white/5 border border-white/10 relative overflow-hidden">
                  ...
                  <div className="text-2xl font-bold text-white">
                    {Math.max(totalLeads, 1).toLocaleString()}
                  </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <button
                        className={`mt-3 text-xs font-bold hover:text-white transition-colors flex items-center gap-1 ${titleStyle}`}
                      >
